...
#     PREREQ_PM => { Class::Data::Inheritable=>q[0.02], Devel::StackTrace=>q[0.9] }
#     VERSION_FROM => q[Class.pm]
...
manifypods : pure_all Class.pm
	@$(POD2MAN) \
	Class.pm \
	$(INST_MAN3DIR)/Exception::Class.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Exception/Class.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"1,03,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT></ABSTRACT>\n\t<AUTHOR></AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Class-Data-Inheritable\" VERSION=\"0,02,0,0\" />\n\t\t<DEPENDENCY NAME=\"Devel-StackTrace\" VERSION=\"0,9,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{Class.pm blib/lib/Exception/Class.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
